...
describe User do
  ...
  describe "return value of authenticate method" do
    ...
    describe "email address with mixed case" do
      ...
      it "should be saved as all lower-case" do
        ...
        expect(@user.reload.email).to_not eq mixed_case_email
      end
    end
  end
  ...
  describe "micropost associations" do
    ...
    it "should not have the right microposts in the wrong order" do
      expect(@user.microposts.to_a).to_not eq [older_micropost, newer_micropost]
    end
